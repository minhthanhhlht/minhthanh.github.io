...
c.models.length!==f.length){a[b.keys(a).length]={collection:c,jqDOMElements:f,info:"Errors at elements: "+c.models.length+"(models) : "+f.length+"(dom)",level:d};return}}d++;b.each(f,function(e,f,h){f=c.models[f];h=g(e);h.data("model_id",f.cid);f.set("html",e.innerHTML,{silent:!0});var l;if(4===f.get("level")){var n=h.find(".td_block_inner, .tdb-block-inner");n.length&&(l=n.attr("id"))}else 2===f.get("level")&&(n=h.find(".tdc-inner-row"),n.length&&(l=n.attr("id")));f.set("blockUid",l);new tdcIFrameData.TdcLiveView({model:f,
