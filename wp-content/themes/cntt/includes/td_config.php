...
//                    'source' => TD_PLUGINS_URL . $td_plugins['TD_COMPOSER'] . '/td-composer.zip', // The plugin source
...
//                    'source' => TD_PLUGINS_URL . $td_plugins['TD_CLOUD_LIBRARY'] . '/td-cloud-library.zip', // The plugin source
//                    'required' => true, // If false, the plugin is only 'recommended' instead of required
//                    'version' => '', // E.g. 1.0.0. If set, the active plugin must be this version or higher, otherwise a notice is presented
//                    'force_activation' => false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch
//                    'force_deactivation' => false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins
...
//                    'source' => TD_PLUGINS_URL . $td_plugins['TD_SOCIAL_COUNTER'] . '/td-social-counter.zip', // The plugin source
...
//                    'source' => TD_PLUGINS_URL . $td_plugins['TD_AMP'] . '/td-amp.zip', // The plugin source
//                    'required' => false, // If false, the plugin is only 'recommended' instead of required
...
//                    'source' => TD_PLUGINS_URL . $td_plugins['TD_NEWSLETTER'] . '/td-newsletter.zip', // The plugin source
//                    'required' => false, // If false, the plugin is only 'recommended' instead of required
//                    'version' => '1.0.0', // E.g. 1.0.0. If set, the active plugin must be this version or higher, otherwise a notice is presented
//                    'force_activation' => false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch
//                    'force_deactivation' => true, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins
